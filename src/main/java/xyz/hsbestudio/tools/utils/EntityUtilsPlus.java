...
public class EntityUtilsPlus {
    ...
    public static List<BlockPos> getSurroundBlocks(PlayerEntity player) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            if (isBlastResistant(pos, BlastResistantType.Mineable)) {
                positions.add(pos);
            }
        }
    ...
    public static BlockPos getCityBlock(PlayerEntity player) {
        ...
        posList.sort(Comparator.comparingDouble(PlayerUtilsPlus::distanceFromEye));
    ...
    public static BlockPos getPosition(Entity pl) {
        return new BlockPos(Math.floor(pl.getX()), Math.floor(pl.getY()), Math.floor(pl.getZ()));
    }
